angular.module('intro', [])
    ...
    .config(['$stateProvider', function ($stateProvider) {
        $stateProvider.state('intro', {
            url: '/intro/:type',
            templateUrl: 'sectionIntro/sectionIntro.tpl.html',
            controller: 'sectionController'
        });
    }])

    .controller('sectionController', function ($scope, $stateParams) {
        ...
        var intro = [
            ...
            },
            {
                "hospitals": {
                    "logo": "hospitals_logo",
                    "text": "hospitals_text",
                    buttons: [{"image": "hospitals_button_1", "to": "list/hospitals"}]
                }
            },
            {
                "lamsa": {
