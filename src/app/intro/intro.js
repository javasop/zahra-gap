 ...
 */
  .controller('IntroCtrl', function($scope, Model, $stateParams) {
    ...
    var intro = [
      ...
      {"amal": {"logo": "amal_logo", "text": "amal_text", buttons: [{"image": "amal_button_1", "to": "books/brochures"}, {"image": "amal_button_2", "to": "story"}, {"image": "amal_button_3", "to": "list/questions"}]}},
      ...
      {"education": {"logo": "education_logo", "text": "education_text", buttons: [{"image": "education_button_1", "to": "books/booklets"}, {"image": "education_button_2", "to": "article"}]}},
      {"hospitals": {"logo": "hospitals_logo", "text": "hospitals_text", buttons: [{"image": "hospitals_button_1", "to": "hospital"}]}},
